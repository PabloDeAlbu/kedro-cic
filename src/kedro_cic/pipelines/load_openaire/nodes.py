...
def load_openaire_researchproduct(df: pd.DataFrame)-> pd.DataFrame:
...
def load_openaire_researchproduct_descriptions(df: pd.DataFrame)-> pd.DataFrame:
    df = _add_openaire_extracted_metadata(df)
...
def load_openaire_researchproduct_originalid(df: pd.DataFrame)-> pd.DataFrame:
    df = _add_openaire_extracted_metadata(df)
