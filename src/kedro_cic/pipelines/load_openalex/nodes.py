...
def load_openalex_stage_work(df_work_raw: pd.DataFrame) -> pd.DataFrame:
...
def load_openalex_author(df: pd.DataFrame)-> pd.DataFrame:
...
def load_openalex_author_institution_year(df: pd.DataFrame)-> pd.DataFrame:
...
def load_openalex_work_concept(df_work_raw, load_datetime=None):
    df_work_raw = _add_openalex_extracted_metadata(df_work_raw)
...
def load_openalex_work_corresponding_author_ids(df_work_raw, load_datetime=None):
    df_work_raw = _add_openalex_extracted_metadata(df_work_raw)
...
def load_openalex_work_referenced_works(df_work_raw, load_datetime=None):
    df_work_raw = _add_openalex_extracted_metadata(df_work_raw)
...
def load_openalex_work_topics(df_work_raw, load_datetime=None):
    df_work_raw = _add_openalex_extracted_metadata(df_work_raw)
